...
export type FingerSide = "left" | "right";
export type FingerLineDrag = `finger-line-${FingerSide}` | `finger-line-${FingerSide}-a` | `finger-line-${FingerSide}-b`;
export type DragTarget = "left" | "right" | "height" | "pan" | "showcase-ring" | "showcase-left" | "showcase-right" | CardLineDrag | FingerLineDrag | null;
